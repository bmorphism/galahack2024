...
exports.getCPPsBrowserApi = exports.getCPPs = exports.cppForUsers = exports.cppForPartner = exports.cppForCurator = exports.cppForCuratorBrowserApi = void 0;
...
function caConfig(cfg, cryptoConfigRoot, localhostName, useTls, asLocalhost) {
...
function peerConfig(cfg, cryptoConfigRoot, localhostName, useTls, asLocalhost) {
...
function ordererConfig(cryptoConfigRoot, localhostName, useTls, asLocalhost) {
...
function ordererAndChannelConfig(cryptoConfigRoot, channelNames, localhostName, useTls, asLocalhost) {
    return {
        orderers: {
...
function channelConfigs(channelNames) {
    return channelNames.reduce((cfg, ch) => ({ ...cfg, ...channelConfig(ch) }), {});
}
function cppForCuratorBrowserApi(cryptoConfigRoot, channelNames, localhostName, useTls, asLocalhost, useServiceDiscovery) {
    return {
...
exports.cppForCuratorBrowserApi = cppForCuratorBrowserApi;
function cppForCurator(cryptoConfigRoot, channelNames, localhostName, useTls, asLocalhost, useServiceDiscovery) {
    return {
        name: "test-network-CuratorOrg",
        version: "1.0.0",
        client: {
...
exports.cppForCurator = cppForCurator;
function cppForPartner(cryptoConfigRoot, channelNames, localhostName, useTls, asLocalhost, useServiceDiscovery) {
    return {
...
exports.cppForPartner = cppForPartner;
function cppForUsers(cryptoConfigRoot, channelNames, localhostName, useTls, asLocalhost, useServiceDiscovery) {
    return {
...
exports.cppForUsers = cppForUsers;
function getCPPs(cryptoConfigRoot, channelNames, localhostName, useTls, asLocalhost, useServiceDiscovery) {
    return {
        curator: cppForCurator(cryptoConfigRoot, channelNames, localhostName, useTls, asLocalhost, useServiceDiscovery),
        partner: cppForPartner(cryptoConfigRoot, channelNames, localhostName, useTls, asLocalhost, useServiceDiscovery),
        users: cppForUsers(cryptoConfigRoot, channelNames, localhostName, useTls, asLocalhost, useServiceDiscovery)
    };
}
exports.getCPPs = getCPPs;
function getCPPsBrowserApi(cryptoConfigRoot, channelNames, localhostName, useTls, asLocalhost, useServiceDiscovery) {
    return {
        curator: cppForCuratorBrowserApi(cryptoConfigRoot, channelNames, localhostName, useTls, asLocalhost, useServiceDiscovery)
    };
}
exports.getCPPsBrowserApi = getCPPsBrowserApi;
